...
import com.jinhu.toptoday.adapter.DragAdapter;
import com.jinhu.toptoday.adapter.OtherAdapter;
...
import com.jinhu.toptoday.view.DragGrid;
import com.jinhu.toptoday.view.OtherGridView;
...
public class ChannelActivity extends Activity implements OnItemClickListener {
    ...
    private void initData() {
        Log.d(TAG, "initData: " + MyApp.getApp());
    ...
    private void saveChannel() {
        ...
        ChannelManage.getManage(MyApp.getApp().getSQLHelper()).saveUserChannel(userAdapter.getChannnelLst());
    ...
    public void onBackPressed() {
        saveChannel();
        super.onBackPressed();
        startActivity(new Intent(ChannelActivity.this, NewMainActivity.class));
        finish();
    }
}
