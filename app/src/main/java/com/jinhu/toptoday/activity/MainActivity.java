...
import com.jinhu.toptoday.fragment.AttentionFragment;
import com.jinhu.toptoday.fragment.HomeFragment;
import com.jinhu.toptoday.fragment.MyFragment;
import com.jinhu.toptoday.fragment.VideoFragment;
...
public class MainActivity extends FragmentActivity {
    ...
    private void setListener() {
        ...
        //默认选中第一个
        mRadioGroup.check(R.id.home_rdo_btn);
    }
    ...
    private void initData() {
        ...
        mBaseFragments.add(new AttentionFragment());
        mBaseFragments.add(new MyFragment());
    }

    private void initView() {
        mRadioGroup = (RadioGroup) findViewById(R.id.rdo_grp);
    }
    ...
    private class MyOnCheckedChangeListener implements RadioGroup.OnCheckedChangeListener {
        ...
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            switch (checkedId) {
                case R.id.home_rdo_btn:
                    position = 0;
                    break;
                case R.id.video_rdo_btn:
                    position = 1;
                    break;
                case R.id.attention_rdo_btn:
                    position = 2;
                    break;
                case R.id.my_rdo_btn:
                    position = 3;
                    break;
                default:
                    position = 0;
