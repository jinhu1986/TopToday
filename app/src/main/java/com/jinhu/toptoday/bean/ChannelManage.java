package com.jinhu.toptoday.bean;

import android.database.SQLException;
import android.util.Log;

import com.jinhu.toptoday.dao.ChannelDao;
...
public class ChannelManage {
	...
	static {
		...
		defaultOtherChannels.add(new ChannelItem(9, "时尚", 2, 0));
		defaultOtherChannels.add(new ChannelItem(10, "国际", 3, 0));
